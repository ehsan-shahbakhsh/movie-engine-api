...
class SeriesCommentController extends Controller
{
     ...
     */
    #[OA\Get(
        path: "/api/v1/series/{slug}/comments",
        description: "Returns a paginated list of comments for the specified series.",
        summary: "Get series comments",
        tags: ["Comments"],
        parameters: [
            new OA\Parameter(
                name: "slug",
    ...
    #[OA\Post(
        path: "/api/v1/series/{slug}/comments",
        description: "Creates a new comment for the specified series.",
        summary: "Create a series comment",
        security: [["sanctum" => []]],
